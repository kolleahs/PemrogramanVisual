...
namespace Tiket_train
{
    public partial class Form1 : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=LAPTOP-2A7QU8GB;Initial Catalog=TrainDB;TrustServerCertificate=True;Integrated Security=True;");
            con.Open();
